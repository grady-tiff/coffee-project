...
function renderCoffee(coffee) {
    ...
    child.innerHTML = `<p class="coffee-name">${coffee.name}</p> <p class="coffee-roast">${coffee.roast} roast</p> <a class="btn btn-sm btn-outline-dark" id="remove${coffee.id}" href="#" onclick="removeCoffee(${coffees.indexOf(coffee)})">Remove</a>`;
